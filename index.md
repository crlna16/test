...
venue: "DKRZ"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Bundesstrasse Hamburg"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "50"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "8"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Apr 1, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Donald Duck", "Minny Mouse"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Goofy", "Trick"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
This is only for our users. You do not need to know anything
{% endcomment %}
{% if site.carpentry == "swc" %}
